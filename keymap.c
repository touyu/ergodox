...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [0] = LAYOUT_ergodox(KC_ESCAPE,KC_1,KC_2,KC_3,KC_4,KC_5,TG(1),KC_DELETE,KC_Q,KC_W,KC_E,KC_R,KC_T,KC_EQUAL,KC_BSPACE,KC_A,KC_S,KC_D,KC_F,KC_G,KC_LSHIFT,CTL_T(KC_Z),KC_X,KC_C,KC_V,KC_B,KC_BSPACE,LT(1,KC_GRAVE),KC_QUOTE,KC_TRANSPARENT,ALT_T(KC_NO),GUI_T(KC_LANG2),KC_TRANSPARENT,KC_TRANSPARENT,KC_TRANSPARENT,KC_ENTER,KC_SPACE,KC_TRANSPARENT,TG(1),KC_6,KC_7,KC_8,KC_9,KC_0,KC_MINUS,KC_TRANSPARENT,KC_Y,KC_U,KC_I,KC_O,KC_P,KC_BSLASH,KC_H,KC_J,KC_K,KC_L,LT(2,KC_SCOLON),GUI_T(KC_QUOTE),MEH_T(KC_NO),KC_N,KC_M,KC_COMMA,KC_DOT,RCTL_T(KC_SLASH),KC_RSHIFT,RGUI_T(KC_LANG1),ALT_T(KC_NO),KC_LBRACKET,KC_RBRACKET,MO(1),KC_LEFT,KC_RIGHT,KC_UP,KC_DOWN,KC_TAB,KC_ENTER),
